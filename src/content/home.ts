export const homeFaq = [
  ...
  },
  {
    ...
    answer:
      "Several courses are beginner-friendly, while others are intermediate. Each course page lists the recommended level so you can choose the right starting point.",
  },
  {
...
export const whyLearn = [
  {
    ...
    body: "Learn in person with instructors. The platform supports notes and assignments — not recorded video lectures.",
  },
  {
    title: "Class notes online",
    body: "Access structured notes and worksheets after sessions so revision stays organized.",
  },
  {
    title: "Real-world projects",
    body: "Assignments mirror audits, page builds, outreach systems, and store improvements.",
  },
  {
    title: "Instructor feedback",
    body: "Submit work and get structured feedback so improvement is guided, not guessed.",
  },
  {
    title: "Progress tracking",
    body: "See notes reviewed, assignment status, attendance, and certificate readiness.",
  },
  {
    title: "Completion certificates",
    body: "Earn a certificate when course requirements are complete — no fake placement claims.",
  },
];

export const learningExperience = [
  { step: "01", title: "Attend", body: "Join live physical classes with your cohort." },
  { step: "02", title: "Review notes", body: "Study class notes and worksheets online." },
  { step: "03", title: "Submit", body: "Send assignments as text, file, or URL." },
  { step: "04", title: "Get Feedback", body: "Receive instructor notes and scores." },
  { step: "05", title: "Improve", body: "Iterate based on clear next actions." },
  { step: "06", title: "Complete", body: "Finish requirements and unlock your certificate." },
];
